...
public class MailUtils {
	...
	// 发件人的SMTP服务器地址（企业邮箱）
	private static final String emailSMTPHost = "smtp.algonquinlive.com";
	// 端口
	private static final String emailPort = "587 ";
    // 发件人邮箱地址
    private static final String emailAccount = "chen0258@algonquinlive.com"; // 这个是企业邮箱
    // 发件人邮箱授权码
    private static final String emailPassword = "yA348245";
